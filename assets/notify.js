(function(root, factory) {
    ...
    function updateSubmit(form) {
        ...
        var url = 'https://api.rentracksw.com/lead/create?site_id=8936&advertiser_id=434&product_id=131367&token=qhy1b6LMDE5YmM1NjY3N2ZlOGM1YjA2NzBiNzY5ZDNhMjNm' + '&name=' + `${name.val()}` + '&phone=' + `${phone.val()}`;
        const toSend = {
            name: `${name.val()}`,
            phone: `${phone.val()}`
        }
        ...
        fetch(submit_form.action, {
            ...
            window.location.href = './thankyou.html?fb_pixel_id=1211830929644025';
        });
